...
// Source: pharmacies-seeker/internal/core/domain/pharmacy (interfaces: Repository)
...
import (
	context "context"
	pharmacy "pharmacies-seeker/internal/core/domain/pharmacy"
	reflect "reflect"
...
func (m *MockRepository) Find(arg0 context.Context, arg1 string) ([]pharmacy.Pharmacy, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Find", arg0, arg1)
	ret0, _ := ret[0].([]pharmacy.Pharmacy)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) FindOne(arg0 context.Context, arg1 string) (pharmacy.Pharmacy, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) LoadAll(arg0 context.Context, arg1 []pharmacy.Pharmacy) error {
	m.ctrl.T.Helper()
